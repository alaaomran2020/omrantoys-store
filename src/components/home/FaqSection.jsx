...
const faqs = [
  {
    ...
    a: 'في متجر عمران، نوفر تغليف هدايا راقي ومبهج مجاناً 100%! عند إتمام طلبك يمكنك تفعيل خيار تغليف الهدية وإضافة نص رسالة إهداء سنقوم بطباعتها على بطاقة أنيقة باسم الطفل وإرفاقها مع الهدية.'
  },
  {
    ...
    <section id="faq" className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <div className="text-center mb-8">
        ...
        <p className="text-xs sm:text-sm text-slate-500 mt-1">
          كل ما تحتاج معرفته عن الأسعار بالجنيه المصري، الشحن، تغليف الهدايا، والدفع
        </p>
      </div>
